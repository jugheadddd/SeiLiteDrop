...
const NoBalanceWarning = ({ chainName, symbol }) => (
  <div className="flex flex-row items-center space-x-4 bg-red-100 bg-opacity-50 border border-red-200 py-4 pl-4 pr-6 rounded-md mt-10">
    <WarningIcon className="flex-shrink-0 text-2xl text-red" />
